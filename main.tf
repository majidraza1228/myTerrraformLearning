...
resource "aws_vpc" "vpc" {
  ...
  tags = {
    Name        = var.vpc_name
    Environment = "varaiable_environment"
    Terraform   = "true"
  }
...
#   }
  ...
  tags = {
    Name = "Syed Raza Github - Ubuntu EC2 Server"
  }
...
resource "aws_instance" "web_server_2" {
  ...
  tags = {
    Name = "Syed Raza Github - New Cloud Var Web EC2 Server 2"
  }
}
